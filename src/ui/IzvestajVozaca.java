...
public class IzvestajVozaca extends JFrame {
    ...
    public IzvestajVozaca(TaxiSluzba taxiSluzba, int VozacID){
        trazeniVozacID = VozacID;
        setSize(600, 300);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (dan.equals("Nije odabrano") && mjesec.equals("Nije odabrano")){
                    ...
                    for (Voznja voznja: taxiSluzba.getListaVoznji()
                        ...
                        int vozacID = voznja.getIdVozaca();
                        if (godinaNadjeneNarudzbe == zahtjevanaGodina && trazeniVozacID == vozacID) {
                    ...
                    */
                    ...
                    for (Voznja voznja: taxiSluzba.getListaVoznji()
                        ...
                        int vozacID = voznja.getIdVozaca();
                        if (mjesecVoznje == zahtjevaniMjesec && zahtjevanaGodina == godinaNadjeneNarudzbe && trazeniVozacID == vozacID){
                            listaOdgovarajucihVoznji.add(voznja);
                        }
                    }
                    ...
                    for (Voznja voznja: taxiSluzba.getListaVoznji()
                        ...
                        int vozacID = voznja.getIdVozaca();
                        if (strDate.equals(odabraniDatum) && trazeniVozacID == vozacID){
                    ...
                    for (Voznja voznja: taxiSluzba.getListaVoznji()
                        ...
                        int vozacID = voznja.getIdVozaca();
                        if(voznja.getVremeNarudzbine().before(zaSedamDana.getTime()) && voznja.getVremeNarudzbine().after(date1) && trazeniVozacID == vozacID){
                            listaOdgovarajucihVoznji.add(voznja);
